    ...
    <Container className="ncc-container">
      ...
      <Row className="ncc-row ncc-page">
        <Col md={12}>
          ...
          <p className="ncc-summary-p">
          Please Note: The estimates above apply to full-time, first-time degree/certificate-seeking undergraduate students only. This estimate is based on an expected family contribution (EFC) of <strong><span className="typography-underline">${report.efcValue.toLocaleString("en-us")}</span></strong>. Your actual EFC will be determined each year by filing the FAFSA.<br />
